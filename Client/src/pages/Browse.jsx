  ...
  return (
    <div className="min-h-screen px-4 sm:px-8 py-4">
      ...
      <h1 className="text-sm sm:text-2xl font-semibold text-gray-700 mt-4 mb-4">
        Search Results:{" "}
        <span className="text-blue-500">({randomjobs.length})</span>
      </h1>
          ...
          randomjobs.map((job) => (
            ...
            >
              ...
              <div className="flex flex-col flex-grow sm:gap-1 gap-3">
                ...
                {/* Apply Button */}
                <button className="text-sm bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg mt-6 sm:px-2 sm:py-2 px-20 py-2 transition-all duration-300 cursor-pointer">
                  Apply
                </button>
              </div>
            </div>
